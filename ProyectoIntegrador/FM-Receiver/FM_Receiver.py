...
class FM_Receiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._squelch_win = RangeWidget(self._squelch_range, self.set_squelch, "Squelch Level", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.connect((self.osmosdr_source, 0), (self.qtgui_time_sink_x_1, 0))
        self.connect((self.osmosdr_source, 0), (self.qtgui_waterfall_sink_x_0, 0))
        self.connect((self.osmosdr_source, 0), (self.rational_resampler_xxx_0, 0))
